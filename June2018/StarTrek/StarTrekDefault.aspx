                ...
                <div class="col-md-4">
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <asp:Table ID="Table1" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="lblPrimaryType" runat="server" Text="" Font-Size="Medium"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell>
                                    <asp:Label ID="lblPrimaryTitle" runat="server" Text="" Font-Size="Medium"></asp:Label>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                    ...
                    <asp:MultiView ID="MultiViewMain" runat="server" ActiveViewIndex="0">
                        <asp:View ID="viewTV" runat="server">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <asp:GridView ID="gvSeriesInfo" runat="server" CssClass="table table-bordered table-hover table-condensed" ShowHeaderWhenEmpty="True" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                                        <Columns>
                        ...
                        <asp:View ID="viewFilms" runat="server">
                            <asp:GridView ID="gvFilms" runat="server" CssClass="table table-bordered table-hover table-condensed" ShowHeaderWhenEmpty="True" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                                <Columns>
                                    <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="Title" />
